...
//    assetPacks.add(":install_time_asset_pack")

    parsedBuildProperties.lookup<JsonArray<String>>("buildSettings.android.playAssetDeliveryResources").firstOrNull()?.forEach {
        assetPacks.add(it.trim())
    }
